export class Music{
  ...
  constructor(private _ref:number,private _name:string,private _refArtist:number,private _refAlbum:number,private _releaseDate:Date,private _liked:boolean,private _price:number,private _cart:boolean){ }
